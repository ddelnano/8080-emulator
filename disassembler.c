...
int disassemble(unsigned char *code) {
    int opcode_len = 1;
    switch (*code) {
        case 0x00: printf("NOP"); break;
        case 0x01: printf("LXI    B,#$%02x%02x", code[2], code[1]); opcode_len = 3; break;
        case 0x02: printf("STAX   B"); break;
        case 0x03: printf("INX    B"); break;
        case 0x04: printf("INR    B"); break;
        case 0x05: printf("DCR    B"); break;
        case 0x06: printf("MVI    B,#$%02x", code[1]); opcode_len = 2; break;
        ...
        case 0x0e: printf("MVI    C,#$%02x", code[1]); opcode_len = 2; break;
        case 0x0f: printf("RRC"); break;
        // Reverse order due to endianess.
        case 0x10: printf("NOP"); break;
        case 0x11: printf("LXI    D,#$%02x%02x", code[2], code[1]); opcode_len = 3; break;
        case 0x12: printf("STAX   D"); break;
        case 0x13: printf("INX    D"); break;
        case 0x14: printf("INR    D"); break;
        case 0x15: printf("DCR    D"); break;
        case 0x16: printf("MVI    D,#$%02x", code[1]); opcode_len = 2; break;
        ...
        case 0x26: printf("MVI    H,#$%02x", code[1]); opcode_len = 2; break;
        case 0x27: printf("DAA"); break;
        case 0x28: printf("NOP"); break;
        case 0x29: printf("DAD    H"); break;
        case 0x2a: printf("LHLD   $%02x%02x", code[2], code[1]); opcode_len = 3; break;
        case 0x2b: printf("DCX    H"); break;
        case 0x2c: printf("INR    L"); break;
        case 0x2d: printf("DCR    L"); break;
        case 0x2e: printf("MVI    L,#$%02x", code[1]); opcode_len = 2; break;
        ...
        case 0xc3: printf("JMP    $%02x%02x", code[2], code[1]); opcode_len = 3; break;
        ...
        case 0xd3: printf("OUT    #$%02x", code[1]); opcode_len = 2; break;
        case 0xd4: printf("CNC    $%02x%02x", code[2], code[1]); opcode_len = 3; break;
        case 0xd5: printf("PUSH   D"); break;
        case 0xd6: printf("SUI    $%02x", code[1]); opcode_len = 2; break;
        case 0xd7: printf("RST    2"); break;
        case 0xd8: printf("RC"); break;
        case 0xda: printf("JC     $%02x%02x", code[2], code[1]); opcode_len = 3; break;
        case 0xdb: printf("IN     $%02x", code[1]); opcode_len = 2; break;
        case 0xdc: printf("CC     $%02x%02x", code[2], code[1]); opcode_len = 3; break;
        case 0xde: printf("SBI    $%02x", code[1]); opcode_len = 2; break;
        case 0xe0: printf("RPO"); break;
        case 0xe1: printf("POP    H"); break;
        case 0xe2: printf("JPO    $%02x%02x", code[2], code[1]); opcode_len = 3; break;
        case 0xe3: printf("XTHL"); break;
        case 0xe4: printf("CPO    $%02x%02x", code[2], code[1]); opcode_len = 3; break;
        case 0xe5: printf("PUSH   H"); break;
        case 0xe6: printf("ANI    #$%02x", code[1]); opcode_len = 2; break;
        case 0xe8: printf("RPE"); break;
        case 0xe9: printf("PCHL"); break;
        case 0xea: printf("JPE    $%02x%02x", code[2], code[1]); opcode_len = 3; break;
        ...
        case 0xf4: printf("CP     $%02x%02x", code[2], code[1]); opcode_len = 3; break;
        ...
        case 0xfe: printf("CPI    #$%02x", code[1]); opcode_len = 2; break;
